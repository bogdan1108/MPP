...
public class Tests {
    ...
    public void testGetAllVolunteers() {
        ...
        ResponseEntity<List<Volunteer>> response = volunteerController.getAllVolunteers();
    ...
    public void testGetVolunteerById() {
        ...
        ResponseEntity<Volunteer> response = volunteerController.getVolunteerById(id);
    ...
    public void testCreateVolunteer() {
        ...
        ResponseEntity<Volunteer> response = volunteerController.createVolunteer(newVolunteer);
    ...
    public void testDeleteVolunteer_NotFound() {
        int id = 100;
        doThrow(new IllegalArgumentException()).when(volunteerService).deleteVolunteer(id);

        // Expect an IllegalArgumentException to be thrown
        assertThrows(IllegalArgumentException.class, () -> volunteerController.deleteVolunteer(id));
    }
